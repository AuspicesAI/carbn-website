        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            {features.map((feature, index) => (
              <div
                key={index}
                className="flex items-start gap-4 p-4 rounded-xl bg-gradient-to-r from-purple-50/12 via-white/12 to-purple-50/12 dark:bg-gradient-to-r dark:from-purple-900/8 dark:via-white/5 dark:to-purple-900/8 backdrop-blur-sm border border-purple-300/40 dark:border-purple-400/25"
              >
