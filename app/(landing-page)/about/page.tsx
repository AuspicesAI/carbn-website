        ...
        <Container>
          <GlassSection className="max-w-4xl mx-auto p-8 md:p-12 text-center">
            ...
            <p className="text-xl text-muted-foreground mt-4">
              Welcome to AuspicesAI, a startup bridging the gap between
            ...
            <GlassSection className="p-8 flex-1">
              <div className="text-center">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  setting industry standards for innovation and trust.
                </p>
              </div>
            </GlassSection>
          </div>
      ...
      <Section>
        <Container>
          <GlassSection className="max-w-4xl mx-auto p-8 md:p-12">
            <GradientHeading size="md" className="text-center mb-8">
              It All Began in 2023
            </GradientHeading>
            <p className="text-lg text-muted-foreground text-center leading-8">
              When AuspicesAI was founded by two first year university students
              who saw a gap in local and global market for security, specially
              when LLMs got popular. Driven by a vision to address this need,
              they launched the startup to provide cybersecurity solutions. What
              started as a university project has evolved into a provider of AI
              powered security technologies.
            </p>
          </GlassSection>
        </Container>
      </Section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <GlassSection className="p-6">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">
                    We strive to push the boundaries of technology to create
              ...
              <GlassSection className="p-6">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">
                    We are dedicated to delivering superior quality in all our
                    work.
                  </p>
                </div>
              </GlassSection>
              ...
              <GlassSection className="p-6">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">
                    We ensure our systems and services consistently perform at
                    their best, providing dependable protection and support.
                  </p>
                </div>
              </GlassSection>
            </div>
