            ...
            <div className="grid gap-6">
              ...
              <section>
                ...
                <ul className="mt-3 list-disc pl-5 text-sm text-muted-foreground space-y-1">
                  <li>
                    Do not misuse, disrupt, or attempt to breach security.
                  </li>
              ...
              <section>
                ...
                <p className="mt-3 text-sm text-muted-foreground">
                  We retain all rights to our content, software, and branding.
                  You may not copy or redistribute except as permitted by law or
              ...
              <section>
                ...
                <p className="mt-3 text-sm text-muted-foreground">
                  We may suspend or terminate access for violations or risks to
                  the service.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mt-3 text-sm text-muted-foreground">
                  Service is provided &quot;as is&quot; without warranties. To
                  the extent permitted by law, we disclaim implied warranties
                  and limit liability.
                </p>
              </section>
