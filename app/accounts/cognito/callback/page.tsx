        ...
        case 'signInWithRedirect':
          try {
            ...
            try {
              ...
              if (userAttributes?.identities) {
                try {
                  ...
                  if (Array.isArray(identities) && identities.length > 0) {
                    ...
                    else if (provider === 'loginwithamazon') detectedProvider = 'Amazon';
                  }
                } catch (e) {
              ...
              console.log(`Successfully authenticated user via ${detectedProvider}:`, {
                userId: user.userId,
              ...
              console.warn('Could not fetch user attributes, proceeding without them:', attrError);
    ...
    return (
      <div className="flex items-center justify-center h-screen w-screen">
        <div className="max-w-xs w-full text-center">
          ...
          <p className="text-xs text-gray-400 mt-2">Redirecting to sign-in page...</p>
        </div>
      </div>
    );
  }
